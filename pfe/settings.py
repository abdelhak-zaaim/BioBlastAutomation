...
STATIC_BLAST_RESULTS = os.path.join(BASE_DIR, 'static/blast_results')
"""
...
ALLOWED_HOSTS = ["blast.zaaim.me", "ec2-54-91-248-112.compute-1.amazonaws.com", "54.91.248.112", "localhost", "127.0.0.1"]
